...
def agent_1_decision(survey_text, code, definition, model, question):
   prompt = f"""
...
def agent_2_decision(survey_text, code, definition, model, question):
    prompt = f"""
...
def agent_3_decision(survey_text, code, definition, model, question):
    prompt = f"""
...
def process_survey_responses(survey_csv_file, code_csv_file, output_file,question):
    ...
    for survey_text in survey_df["survey_response"]:
        ...
        for code, definition in code_dict.items():
            itr = itr + 1
            yes_vote = 0
            agent1_1 = agent_1_decision(survey_text, code, definition, model_1, question)
            agent1_2 = agent_1_decision(survey_text, code, definition, model_2, question)
            agent1_3 = agent_1_decision(survey_text, code, definition, model_3, question)
            print(f"{model_3}: {agent1_3}")

            agent2_1 = agent_2_decision(survey_text, code, definition, model_1, question)
            agent2_2 = agent_2_decision(survey_text, code, definition, model_2, question)
            agent2_3 = agent_2_decision(survey_text, code, definition, model_3, question)

            agent3_1 = agent_3_decision(survey_text, code, definition, model_1, question)
            agent3_2 = agent_3_decision(survey_text, code, definition, model_2, question)
            agent3_3 = agent_3_decision(survey_text, code, definition, model_3, question)
